...
import { GET_ALL_CUSTOMER_VISIT_DATA_BY_ID, GET_ALL_USERS_DROPDOWN, GET_VISITOR_DATA_BY_MOBILE, SAVE_VISITOR_DATA, SEND_OTP, VERIFY_TEXT_OTP, MARK_VISITOR_OUT, GET_USER_BY_TOKEN } from "../../helpers/url_helper";
...
import { FaCalendar, FaCheckCircle, FaMobileAlt, FaTeamspeak, FaUser, FaUserTie } from "react-icons/fa";
...
export default function VisitorEntryScreen() {
  ...
  return (
    <PageContent>
      ...
      {(isPending || isPendingMobileCheck || isPendingOtpSend || isVerifyOtpSend || isLoading) && (<ScreenLoader />)}
                ...
                {tokenInfo && (
                  <Col md="6">
                    <div style={{
                      ...
                      <div style={{
                        fontSize: 10.5, color: defaultTheme.primary,
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12.5 }}>
                          ...
                          <strong style={{ color: '#0F172A' }}>{tokenInfo.name}</strong>
                        </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12.5 }}>
                          ...
                          <strong style={{ color: '#0F172A' }}>
                            {formatDate(tokenInfo.tokenDate)}
                          </strong>
                        </div>
